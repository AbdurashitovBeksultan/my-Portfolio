		...
		<Card className="quote-card-view">
			<Card.Body>
				<blockquote className="blockquote mb-0">
					...
					<p style={{ color: "aqua" }}>
						В целом я считаю себя опытным Frontend, разработчиком который всегда
						готов принять новые вызовы и научиться новым навыкам чтобы создавать
						качественные и инновационные{" "}
					</p>
